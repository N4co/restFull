...
@Entity
@Table(name = "users")
public class UserAuthorized implements UserDetails, Serializable {
    ...
    @JoinColumn(name = "user_permission", joinColumns = {@JoinColumn(name = "id_user")},
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserAuthorized that)) return false;
